      ...
      <div class="bg-white rounded-2xl shadow-sm overflow-hidden border border-slate-100 flex flex-col justify-between group">
        ...
        <div class="p-3 pt-0">
          ...
          <div class="flex items-center justify-between mt-1.5 pt-1.5 border-t border-slate-50">
            ...
            <button onclick="addToCart('${p.id}', this)" ${p.stock <= 0 ? 'disabled class="bg-slate-300 text-slate-500 text-[10px] font-bold px-3 py-2 rounded-xl cursor-not-allowed"' : 'class="bg-pink-700 text-white text-[10px] font-bold px-3 py-2 rounded-xl hover:bg-pink-800 active:scale-95 transition-all"'}>
  ...
  function openProductDetail(productId) {
    ...
    if (product.stock <= 0) {
      ...
      addBtn.className = 'w-full bg-pink-700 text-white font-bold text-sm py-3 rounded-2xl hover:bg-pink-800 active:scale-95 transition';
  ...
  function flashAddToCartButton(btn) {
    ...
    btn.className = originalClass.replace(/bg-pink-700/g, 'bg-emerald-600').replace(/hover:bg-pink-800/g, 'hover:bg-emerald-600');
