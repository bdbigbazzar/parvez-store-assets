  ...
  function renderTejCard(id, d) {
    ...
    if (d.mediaType === 'image' && d.mediaData) {
      mediaHtml = `<div class='mt-2.5 -mx-4 cursor-pointer bg-slate-100' onclick='openTejView("${id}")'><img src='${d.mediaData}' class='w-full max-h-[520px] object-cover' loading='lazy'></div>`;
