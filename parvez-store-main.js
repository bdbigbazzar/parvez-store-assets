  ...
  function renderTejCard(id, d) {
    ...
    if (d.mediaType === 'image' && d.mediaData) {
      ...
      // ✅ [FIX] ভিডিওতে ক্লিক করলে এখন ইনলাইনে না খুলে ফেসবুকের মতো ফুলস্ক্রিন
      // ভার্টিকাল সোয়াইপযোগ্য ভিউয়ারে (existing openTejShorts) খুলবে
      mediaHtml = `<div class='mt-2.5 -mx-4 bg-black relative cursor-pointer' onclick='openTejShorts("${id}")'>
        <video src='${d.mediaData}' class='w-full max-h-[520px]' preload='metadata' playsinline muted></video>
